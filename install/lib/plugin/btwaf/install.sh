...
Install_btwaf()
{
	...
	wget -O $pluginPath/btwaf_main.py $download_Url/install/lib/plugin/btwaf/btwaf_main.py -T 5
	wget -O $pluginPath/btwaf_init.py $download_Url/install/lib/plugin/btwaf/btwaf_init.py -T 5
	wget -O $pluginPath/index.html $download_Url/install/lib/plugin/btwaf/index.html -T 5
	wget -O $pluginPath/info.json $download_Url/install/lib/plugin/btwaf/info.json -T 5
	wget -O $pluginPath/icon.png $download_Url/install/lib/plugin/btwaf/icon.png -T 5
	wget -O /www/server/panel/vhost/nginx/btwaf.conf $download_Url/install/lib/plugin/btwaf/btwaf.conf -T 5
	\cp -a -r /www/server/panel/plugin/btwaf/icon.png /www/server/panel/static/img/soft_ico/ico-btwaf.png
	wget -O $pluginPath/btwaf.zip $download_Url/install/lib/plugin/btwaf/btwaf.zip -T 5
