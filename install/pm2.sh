...
if [ "${1}" == 'install' ];then
  ...
  . ~/.bashrc
	...
	wget -O /www/server/panel/plugin/pm2/pm2_main.py $download_Url/install/lib/plugin/pm2/pm2_main.py -T 5
	wget -O /www/server/panel/plugin/pm2/index.html $download_Url/install/lib/plugin/pm2/index.html -T 5
	wget -O /www/server/panel/plugin/pm2/info.json $download_Url/install/lib/plugin/pm2/info.json -T 5
	wget -O /www/server/panel/plugin/pm2/icon.png $download_Url/install/lib/plugin/pm2/icon.png -T 5
	wget -O /www/server/panel/static/img/soft_ico/ico-pm2.png $download_Url/install/lib/plugin/pm2/icon.png -T 5
