...
if [ -f "/usr/bin/apt-get" ];then
	...
	if [ "$isDebian" != "" ];then
		wget -O install.sh http://download.bt.cn/install/install-ubuntu-en.sh && bash install.sh
		exit;
	else
		wget -O install.sh http://download.bt.cn/install/install-ubuntu-en.sh && sudo bash install.sh
		exit;
	fi
fi
...
echo "
+----------------------------------------------------------------------
| aaPanel 1.0 FOR CentOS/Redhat/Fedora/Ubuntu/Debian
+----------------------------------------------------------------------
| Copyright © 2015-2017 AA-SOFT(https://www.aapanel.com) All rights reserved.
+----------------------------------------------------------------------
...
wget -O panel.zip $download_Url/install/src/panel_en.zip -T 10
...
address=""
address=`curl -sS --connect-timeout 10 -m 60 https://www.aapanel.com/Api/getIpAddress`
if [ "$address" == "" ];then
	address="SERVER_IP"
fi
...
echo -e "=================================================================="
echo  "aaPanel: http://$address:$port"
echo -e "username: $username"
echo -e "password: $password"
echo -e "\033[33mWarning:\033[0m"
echo -e "\033[33mIf you cannot access the panel, \033[0m"
echo -e "\033[33mPlease accept port (8888|888|80|443|20|21) in the security group\033[0m"
echo -e "=================================================================="
